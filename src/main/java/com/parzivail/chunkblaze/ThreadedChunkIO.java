...
public class ThreadedChunkIO implements Runnable
{
	/**
	 * Instance of ThreadedFileIOBase
	 */
	private static final ThreadedChunkIO INSTANCE = new ThreadedChunkIO();
	...
	private ThreadedChunkIO()
	{
		Thread thread = new Thread(this, "Chunkblaze IO Thread");
	 ...
	 */
	public static ThreadedChunkIO getThreadedIOInstance()
	{
		return INSTANCE;
	}
